"""
TraceX Forensic Trajectory & Event Reconstructor.

Reconstructs forensic timelines, trajectory direction vectors, loitering incidents,
sudden speed changes, and entry/exit activities from TraceX tracked detections.
"""
...
class TraceXForensicReconstructor:
    ...
    def reconstruct_from_detections(
        ...
        """
        Reconstruct higher-level forensic events and summary from timestamped TraceX detections.
        """
        ...
        summary_text = (
            f"TraceX forensic reconstruction tracked {len(track_summaries)} distinct entities "
