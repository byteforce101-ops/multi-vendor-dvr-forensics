    ...
    const handleExportDossier =
      () => {
        ...
        try {
          ...
          console.error(
            'Failed to export forensic dossier:',
            error,
          );

          window.alert(
            'The forensic dossier could not be exported. Check the browser console for details.',
          );
      ...
      >
        ...
        >
          ...
          <button
            ...
            title={
              analysis
                ? 'Export the complete forensic analysis as a PDF dossier'
                : 'Run an analysis before exporting a dossier'
            }
          >
              ...
              <div>
...

                {
                  analysis
                    ...
                    .fps == null
                    ? '—'
                    : `${analysis.metadata.fps.toFixed(2)} FPS`
                }
              </div>
