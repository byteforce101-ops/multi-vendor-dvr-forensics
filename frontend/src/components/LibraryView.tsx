  ...
  return (
    ...
    >
      ...
      <div className="spotlight-card p-6 sm:p-7 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <span className="shimmer-badge text-[11px] font-semibold px-2.5 py-0.5 rounded-md text-blue-900 border border-blue-200">
            Immutable Storage
          </span>
        ...
        <div className="flex items-center gap-2.5 self-start sm:self-auto">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-lg bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-700 hover:text-slate-900 text-xs font-medium flex items-center gap-2 transition-all cursor-pointer shadow-xs active:scale-98"
          >
      ...
      <div className="spotlight-card p-3 flex items-center justify-between gap-3">
        <div className="relative w-full sm:w-96">
          ...
          <input
            ...
            className="w-full pl-10 pr-3.5 py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-700 focus:bg-white focus:ring-1 focus:ring-blue-700 transition-all"
          />
        </div>
          ...
          {filtered.map((item) => (
            ...
            >
              <div>
                ...
                <div className="mt-3 p-2.5 bg-slate-50 rounded-lg border border-slate-100 font-mono text-[11px] text-slate-700 break-all">
              ...
              <div className="pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-400">
                ...
                <span className="text-blue-800 font-semibold flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
